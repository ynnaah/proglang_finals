...
def reservationTicket(parentTkClass: tk, dataToShow):
    ...
    def okButton():
        reservationDetailsWindow.destroy()
        pass

    def cancelButton():
        srcKey = dataToShow[0]
        answer = askyesno(title='Confirmation Warning', message='Are you sure?')
        ...
        with open("reservations", "r") as file:
            ...
            while counter < line_length:
                if answer and line[counter] == srcKey+"\n":
    ...
    def refill_slot(line_no, venue):
        ...
        showinfo(title='Notice!', message='Reservation Cancelled!')
        reservationDetailsWindow.destroy()
